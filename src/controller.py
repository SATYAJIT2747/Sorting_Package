# src/controller.py
"""Defines the main Sorter controller class to select algorithms."""
from typing import List, Literal
from .sorters import BubbleSorter, SelectionSorter, QuickSorter, MergeSorter , ShellSorter
from .base_sorter import BaseSorter

# allowed algorithm names for type hinting
AlgorithmName = Literal["bubble", "selection", "quick", "merge" , "shell"]
